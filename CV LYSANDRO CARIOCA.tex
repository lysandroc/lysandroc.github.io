...
\end{tabular*}
\hfill \break
Software engineer with 7 years of experience in application design and development. Expert in Javascript. Driven to constantly learn, improve and solve. 
%--------PROGRAMMING SKILLS------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{3D Printer Dashboard}
          {Developing a solution that shows all information about 3D printer usage for a global printer manufacturer. Implementing a thin REST layer written in Golang that reads information from the data lake; Creating new dashboards using Reactjs and Typescript; Contributing to the internal DevOps organization creating new CI/CD templates used across teams. }
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Private Pension}
          {A solution that sells a private pension fund to customers. Developed several screens using ReactJS based on UX requirements; code was covered by 85\% of unit testing; Led a team of three developers to build an end to end testing project using the cypress framework.   }
