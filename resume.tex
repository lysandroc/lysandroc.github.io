    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Global Relationship Platform}
          {Creating a new product for \href{https://en.wikipedia.org/wiki/Natura_Co}{Natura\&Co} to keep track of the beauty consultant relationship time in several countries. Implementing an event-driven design architecture to calculate asynchronous relationship time using AWS Lambda, AWS SQS, NodeJS, and ScyllaDB. Adding new features in a NodeJS and ReactJS application. Monitoring applications through Grafana, Kibana, and Kubernetes.}
      \resumeItemListEnd
