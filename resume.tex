...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
    {Stay22} {}
    {Senior Software Developer}{Nov. 2021 - Present}
    \resumeItemListStart
      \resumeItem{Map}
        {Developing the next map generation at \href{https://stay22.com/}{Stay22}. The API is written in Typescript, Nodejs and GraphQL, and the frontend uses Typescript, React, Mapbox and Styled Components. I also maintain internal common libraries shared between our internal products.}
    \resumeItemListEnd

    \resumeSubheading
      {SysMap Solutions Software} {}
      {Senior Software Developer}{Feb. 2021 - Nov. 2021}
      \resumeItemListStart
    ...
    \resumeSubheading
      {Instituto Atlântico} {}
      {Senior Software Developer}{Apr. 2020 - Feb. 2021}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Senior Software Developer}{May 2019 - Apr. 2020}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      { Senior Software Developer}{Fev. 2014 - Apr. 2019}
      \resumeItemListStart
